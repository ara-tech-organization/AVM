...
export const aboutStory = {
  ...
  paragraphs: [
    'At AVM Smiles, we are committed to providing outstanding dental care by combining clinical expertise, state-of-the-art technology and empathetic patient service. We are a trusted dental clinic in Pondicherry, offering complete dental treatments tailored to every individual patient.',
  ...
  vision:
    'Our vision is to be recognised as one of the leading dental healthcare providers in Pondicherry — known for excellence in dentistry, innovation in treatment and outstanding patient experiences. We aim to empower every patient with healthy smiles that contribute to overall well-being and quality of life.',
}
